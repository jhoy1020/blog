...
const PrivacyPolicy = (): JSX.Element => {
  return (
    <div className='privacy-container'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Josh Hoy's Personal Blog.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Josh Hoy's Personal Blog,
          accessible from http://www.joshhoy.com
        </li>{' '}
        <li>
      ...
      <ul>
        <li>
          By visiting this page on our website: https://www.joshhoy.com/contact
        </li>
      </ul>
    </div>
  );
